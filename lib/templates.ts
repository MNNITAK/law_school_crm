...
export const WA_TEMPLATES: WaTemplate[] = [
  {
    ...
    student:
      "Welcome to City Law College, Lucknow! 🏛️\n\n⚖️ *BA LL.B (Hons.)* — 5-year integrated, after Class 12 (min 45%, 40% SC/ST)\n⚖️ *LL.B* — 3-year, after graduation (min 50%)\n\n🎓 University of Lucknow degree (College Code 1238)\n📍 Sector 9, Jankipuram Vistar\n💺 120 seats each, pure merit basis\n\nMain Aria hoon, aapki admissions counsellor — kuch bhi poochiye! 😊",
    parent:
  ...
  },
  {
    ...
    student:
      "Hi {name}! 👋 Riya here from City Law College. Great news — based on what you shared, you're *eligible* to apply for 2026–27. 🎉 Want me to walk you through the next step? It takes 5 minutes.",
    parent:
  ...
  },
  {
    ...
    student:
      "Hi {name} 🙂 kal aapne law admission ke baare mein poocha tha — main bas soch rahi thi, koi doubt reh gaya kya? Ek chhota sa sawal bhi ho toh poochiye, isi liye toh main hoon! ⚖️",
    parent:
  ...
  },
  {
    ...
    student:
      "{name}, ek update — BA LL.B ki 120 seats merit basis pe fill hoti hain, aur applications rolling review pe hain. 📋 Jitna pehle apply, utni strong standing. Aapka profile accha hai — main nahi chahti aap window miss karein. Apply karein? 🙌",
    parent:
  ...
  },
  {
    ...
    student:
      "Quick story {name} — ek student thi jo pehle moot court mein bolne se darti thi. Final year tak woh High Court advocate ke saath intern kar rahi thi. 💪 Yahi 5 saal ka difference hai. ⚖️ Aapko kya banna hai — litigator, judge, corporate lawyer?",
    parent:
  ...
  },
  {
    ...
    student:
      "{name}, sach kahoon? College choose karne ka best tareeqa hai uske corridors mein chalna. 🏛️ Aaiye — moot court hall dekhiye, library dekhiye, seniors se miliye. Sector 9, Jankipuram Vistar. Kaunsa din suit karega? Main visit fix kar deti hoon! 😊",
    parent:
  ...
  },
  {
    ...
    student:
      "Hi {name}! Kaafi din ho gaye 🙂 Admissions 2026–27 ke liye seats merit pe fill ho rahi hain — aur mujhe laga aapko yaad dila doon, kyunki aapka interest genuine tha. Law ka plan abhi bhi hai? Main yahin hoon. ⚖️",
    parent:
  ...
  },
  {
    ...
    student:
      "{name}, aaj baat karke accha laga! 😊 Jo bhi humne discuss kiya — agla step main yahan hoon guide karne ke liye. Koi bhi sawaal ho, kabhi bhi message kariye. Aur campus visit ka plan pakka rakhiye! 🏛️",
    parent:
